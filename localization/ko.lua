...
stake_mp_antimatter = {
  ...
  misc = {
    ...
    dictionary = {
      ...
      b_start = "시작",
      b_wait_for_host_start = { "대기 중:", "호스트 시작" },
      b_wait_for_players = { "대기 중:", "플레이어" },
      b_wait_for_guest_ready = { "대기 중:", "게스트 준비" },
      ...
      k_standard = "스탠다드",
      k_sandbox = "샌드박스",
      k_sandbox_description =
      "질투심 많은 아이돌 셋이당신의 런을 두고 경쟁합니다.\n조커 일부가 특이한 효과로 교체되며\n게임 규칙이 크게 달라집니다.\n\n(자세한 내용은 위키 참고)",

      k_vanilla = "바닐라",
      k_vanilla_description =
      ...
      k_majorleague_description =
      "공식 메이저 리그 룰셋.\n\n경쟁 설정의 바닐라 카드로\n빠른 템포의 대전을 진행합니다.",

      k_minorleague = "마이너 리그",
      k_minorleague_description =
      "공식 마이너 리그 룰셋.\n\n메이저 리그보다\n조금 여유 있는 타이머로\n경쟁전을 진행합니다.",

      k_ranked = "랭크",
      k_ranked_description =
      "공식 경쟁 룰셋.\n\n설정이 고정된 스탠다드 규칙으로\n실력을 겨루는 모드입니다.\n\n(권장 Steamodded 버전 필요)",

      k_badlatro = "배드라트로",
      k_badlatro_description =
      "디스코드 커뮤니티에서 제작된\n주간 룰셋입니다.\n\n다수의 카드와 아이템이\n대규모로 금지됩니다.",

      k_attrition = "어트리션",
      k_attrition_description =
      "첫 앤티 이후부터\n모든 보스 블라인드가\n네메시스 블라인드가 됩니다.\n\n시작부터 전투를 준비해야 합니다.",

      k_showdown = "쇼다운",
      k_showdown_description =
      "처음 2개의 앤티 이후\n모든 블라인드가\n네메시스 블라인드가 됩니다.\n\n전투 전 준비 시간이 주어집니다.",

      k_survival = "서바이벌",
      k_survival_description =
      "가장 먼 블라인드를\n돌파한 플레이어가 승리합니다.\n\n네메시스 블라인드는 없으며\n점진적인 성장에 집중합니다.",

      k_weekly = "위클리",
      k_weekly_description =
      "주기적으로 변경되는\n특별 룰셋입니다.\n\n이번 주 규칙을 직접 확인하세요!",

      k_smallworld = "스몰 월드",
      k_smallworld_description =
      "조커, 소모품, 바우처,\n태그의 대부분이\n매 게임 무작위로 금지됩니다.\n\n중복은 허용됩니다.",

      k_speedlatro = "스피드라트로",
      k_speedlatro_description =
      "각 PvP 블라인드 사이에\n147초의 빠른 타이머가 적용됩니다.\n\n빠른 판단이 요구됩니다.",
   ...
   v_dictionary = {
      ...
      a_mp_code = { "코드: #1#" },
      a_mp_idea = { "아이디어: #1#" },
      a_mp_skips_ahead = { "#1# 스킵 앞섬" },
      a_mp_skips_behind = { "#1# 스킵 뒤처짐" },
      a_mp_skips_tied = { "동률" },
